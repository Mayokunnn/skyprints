...
export default function QuotePage() {
  const services = [
    ...
    { id: "banners", label: "Banners & Posters", popular: true },
    {
      ...
      label: "Corporate Branding Package",
      popular: false,
    },
  ...
  const features = [
    {
      ...
      description:
        "Get a preliminary quote within minutes of submitting your request",
    },
    {
      icon: <FileText className="h-8 w-8 text-orange-500" />,
      title: "Detailed Proposal",
      description:
        "Receive a comprehensive proposal with specifications and timeline",
    },
    {
            ...
            <div className="text-center max-w-4xl mx-auto relative z-10">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl mb-8 text-pretty max-w-3xl mx-auto">
                  Tell us about your project and receive a detailed, competitive
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                ...
                be. All information is kept confidential.
              </p>
            </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input
                          id="quantity"
                          placeholder="e.g., 1000 business cards"
                        />
                      </div>
                      <div className="space-y-2">
                        ...
                        <Input
                          id="size"
                          placeholder="e.g., A4, 85mm x 55mm, Custom"
                        />
                      </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        >
                          ...
                          <option value="standard-paper">
                            Standard Paper (80gsm)
                          </option>
                          <option value="premium-paper">
                            Premium Paper (120gsm)
                          </option>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <option value="asap">
                          ASAP (Rush Order - Additional Fees Apply)
                        </option>
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-orange-500 transition-colors">
                    ...
                    <p className="text-gray-600 mb-2">
                      Upload your design files, logos, or reference materials
                    </p>
                    <p className="text-sm text-gray-500 mb-4">
                      Supported formats: AI, EPS, PDF, PSD, JPG, PNG (Max 10MB
                      each)
                    </p>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start space-x-2">
                      ...
                      <Label htmlFor="designServices" className="text-sm">
                        I need design services (our team will create the design
                        for you)
                      </Label>
                    </div>
                    ...
                    <div className="flex items-start space-x-2">
                      ...
                      <Label htmlFor="newsletter" className="text-sm">
                        Subscribe to our newsletter for printing tips and
                        special offers
                      </Label>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start space-x-2">
                      ...
                      <div className="text-sm text-blue-800">
                        ...
                        <ul className="space-y-1 text-xs">
                          ...
                          <li>
                            • You'll receive a detailed quote with
                            specifications
                          </li>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <div className="bg-white rounded-lg p-6 shadow-sm">
                ...
                <p className="text-gray-600 text-sm">
                  Professional guidance throughout your project
                </p>
              </div>
            </div>
          </div>
